...
if($action==='room_meta'){ $b=base_path(); send_json(['ok'=>true,'room'=>$room,'urls'=>['admin'=>$b.'/admin.php?room='.$room,'stage'=>$b.'/stage.php?room='.$room,'adminMain'=>$b.'/admin/main','stageMain'=>$b.'/stage/main','adminSub'=>$b.'/admin/sub','stageSub'=>$b.'/stage/sub']]); }
